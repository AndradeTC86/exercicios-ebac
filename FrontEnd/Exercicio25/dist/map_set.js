...
var _iterator = _createForOfIteratorHelper(pessoa.entries()),
  _step;
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var _step$value = _slicedToArray(_step.value, 2),
      chave = _step$value[0],
      valor = _step$value[1];
    console.log("Chave: ".concat(chave, ", Valor: ").concat(valor));
  }
} catch (err) {
  _iterator.e(err);
} finally {
...
var arrayNomes = ['João', 'Lucas', 'Ana', 'Maria', 'Pedro', 'Lucas'];
var arraySet = new Set([].concat(arrayNomes));
